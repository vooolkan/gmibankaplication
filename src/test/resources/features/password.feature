...
Feature: Ana sayfadaki sifre bolumu duzenlenebilir olmalidir.
  ...
  Scenario:Kullanici mevcut passwordu degistirmek istediginde mevcut passwordu,yeni password olarak kullanamaz.
    ...
    And Kullanici Mevcut sifre "<Mevcut sifre>", Yeni sifre ve Yeni sifre tekrar textboxlarinin hepsine mevcut sifreyi yazar
  ...
  Scenario: Kullanici yeni passwordde kucuk harf kullandiginda seviye grafigi degisir.
    Given Kullanici Mevcut sifre "<Mevcut sifre>" textboxina mevcut sifreyi girer
    And Kullanici Yeni sifre "<Yeni sifre>" textboxina icinde kucuk harf olmayan 6 haneli password girer
    And Kullanici seviye grafigini kontrol eder
    And Kullanici 6 haneli passworde 7. hane olarak herhangi bir kucuk harf "<kucuk harf>" ekler
  ...
  Scenario: Kullanici yeni passwordde buyuk harf kullandiginda seviye grafigi degisir.
    Given Kullanici Mevcut sifre "<Mevcut sifre>" textboxina mevcut sifreyi girer
    And Kullanici Yeni sifre "<Yeni sifre>" textboxina icinde buyuk harf olmayan 6 haneli password girer
    And Kullanici seviye grafigini kontrol eder
    And Kullanici 6 haneli passworde 7. hane olarak herhangi bir büyük harf "<büyük harf>" ekler
    Then Kullanici seviye grafiginde degisim oldugunu dogrular
